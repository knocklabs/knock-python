...
- <code title="put /v1/users/{user_id}/channel_data/{channel_id}">client.users.<a href="./src/knockapi/resources/users/users.py">set_channel_data</a>(user_id, channel_id) -> <a href="./src/knockapi/types/recipients/channel_data.py">ChannelData</a></code>
...
- <code title="post /v1/users/bulk/identify">client.users.bulk.<a href="./src/knockapi/resources/users/bulk.py">identify</a>() -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
- <code title="post /v1/users/bulk/preferences">client.users.bulk.<a href="./src/knockapi/resources/users/bulk.py">set_preferences</a>() -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
...
- <code title="put /v1/objects/{collection}/{object_id}/channel_data/{channel_id}">client.objects.<a href="./src/knockapi/resources/objects/objects.py">set_channel_data</a>(collection, object_id, channel_id) -> <a href="./src/knockapi/types/recipients/channel_data.py">ChannelData</a></code>
...
- <code title="post /v1/objects/{collection}/bulk/subscriptions/add">client.objects.bulk.<a href="./src/knockapi/resources/objects/bulk.py">add_subscriptions</a>(collection) -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
- <code title="post /v1/objects/{collection}/bulk/set">client.objects.bulk.<a href="./src/knockapi/resources/objects/bulk.py">set</a>(collection) -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
...
- <code title="post /v1/tenants/bulk/set">client.tenants.bulk.<a href="./src/knockapi/resources/tenants/bulk.py">set</a>() -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
...
- <code title="post /v1/messages/batch/interacted">client.messages.batch.<a href="./src/knockapi/resources/messages/batch.py">mark_as_interacted</a>() -> <a href="./src/knockapi/types/messages/batch_mark_as_interacted_response.py">BatchMarkAsInteractedResponse</a></code>
...
- <code title="get /v1/providers/slack/{channel_id}/channels">client.providers.slack.<a href="./src/knockapi/resources/providers/slack.py">list_channels</a>(channel_id, \*\*<a href="src/knockapi/types/providers/slack_list_channels_params.py">params</a>) -> <a href="./src/knockapi/types/providers/slack_list_channels_response.py">SlackListChannelsResponse</a></code>
...
- <code title="post /v1/schedules">client.schedules.<a href="./src/knockapi/resources/schedules.py">create</a>() -> <a href="./src/knockapi/types/schedule_create_response.py">ScheduleCreateResponse</a></code>
- <code title="put /v1/schedules">client.schedules.<a href="./src/knockapi/resources/schedules.py">update</a>() -> <a href="./src/knockapi/types/schedule_update_response.py">ScheduleUpdateResponse</a></code>
...
- <code title="delete /v1/schedules">client.schedules.<a href="./src/knockapi/resources/schedules.py">delete</a>() -> <a href="./src/knockapi/types/schedule_delete_response.py">ScheduleDeleteResponse</a></code>
...
- <code title="post /v1/channels/{channel_id}/messages/bulk/{action}">client.channels.bulk.<a href="./src/knockapi/resources/channels/bulk.py">update_message_status</a>(channel_id, action) -> <a href="./src/knockapi/types/bulk_operation.py">BulkOperation</a></code>
...
- <code title="post /v1/audiences/{key}/members">client.audiences.<a href="./src/knockapi/resources/audiences.py">add_members</a>(key) -> str</code>
...
- <code title="delete /v1/audiences/{key}/members">client.audiences.<a href="./src/knockapi/resources/audiences.py">remove_members</a>(key) -> str</code>
