...
from .bulk_identify_response import BulkIdentifyResponse as BulkIdentifyResponse
...
from .bulk_set_preferences_response import BulkSetPreferencesResponse as BulkSetPreferencesResponse
