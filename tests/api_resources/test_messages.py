...
class TestMessages:
    ...
    def test_method_list(self, client: Knock) -> None:
        ...
        assert_matches_type(SyncEntriesCursor[Message], message, path=["response"])
    ...
    def test_method_list_activities(self, client: Knock) -> None:
        ...
        assert_matches_type(SyncEntriesCursor[Activity], message, path=["response"])
    ...
    def test_method_list_events(self, client: Knock) -> None:
        ...
        assert_matches_type(SyncEntriesCursor[MessageEvent], message, path=["response"])
...
class TestAsyncMessages:
    ...
    async def test_method_list(self, async_client: AsyncKnock) -> None:
        ...
        assert_matches_type(AsyncEntriesCursor[Message], message, path=["response"])
    ...
    async def test_method_list_activities(self, async_client: AsyncKnock) -> None:
        ...
        assert_matches_type(AsyncEntriesCursor[Activity], message, path=["response"])
    ...
    async def test_method_list_events(self, async_client: AsyncKnock) -> None:
        ...
        assert_matches_type(AsyncEntriesCursor[MessageEvent], message, path=["response"])
