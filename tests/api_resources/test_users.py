...
from knock.types.shared import User, Schedule, ChannelData, Subscription, PreferenceSet
...
class TestUsers:
    ...
    def test_method_list_messages(self, client: Knock) -> None:
        ...
        assert_matches_type(SyncEntriesCursor[UserListMessagesResponse], user, path=["response"])
...
class TestAsyncUsers:
    ...
    async def test_method_list_messages(self, async_client: AsyncKnock) -> None:
        ...
        assert_matches_type(AsyncEntriesCursor[UserListMessagesResponse], user, path=["response"])
